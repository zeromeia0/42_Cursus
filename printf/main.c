...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/04/19 22:38:28 by vivaz-ca          #+#    #+#             */
/*   Updated: 2025/04/19 23:00:20 by vivaz-ca         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
	...
	char *z = "ola bom dia %K%s %p %% %i %i %X %u";
	printf("a''''%d''''\n", printf(z, "a todos", NULL, NULL, 2147483647, -2147483648, -32, -12334567));
	ft_printf("\n");
	ft_printf("a''''%d''''\n", ft_printf(z, "a todos", NULL, NULL, 2147483647, -2147483648, -32, -12334567));
	...
	// compile ft_print*.c libft/*fd.c libft/ft_itoa.c convert_nbr_to_hexa.c libft/*dup.c libft/ft_*len.c libft/ft_*lcpy.c
}
